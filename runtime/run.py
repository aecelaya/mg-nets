...
class RunTime:
    ...
    def predict_and_evaluate_val(self, model, df, ds):
    ...
    def train(self):
        ...
        for fold in self.args.folds:
            ...
            checkpoint = Checkpoints(best_model, best_val_loss)
            ...
            best_model = checkpoint.get_best_model()
            ...
            self.predict_and_evaluate_val(best_model, test_df, test_loader)
